    ...
    <footer className="bg-white pt-16 pb-8 border-t border-gray-100" aria-label="Site footer">
      <div className="container-koonji">
        ...
        <div className="bg-brand rounded-[2rem] p-10 md:p-14 mb-16 flex flex-col md:flex-row items-center justify-between shadow-2xl shadow-brand/20 relative overflow-hidden">
          ...
          <Link
            to="/contact-us"
            className="relative z-10 bg-white text-brand px-8 py-4 rounded-full font-semibold hover:bg-gray-50 hover:scale-105 hover:shadow-xl transition-all duration-300 flex items-center gap-2 shrink-0"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-8 mb-16">
          ...
          {/* Brand & Description */}
          <div className="md:col-span-4 lg:col-span-4 pr-0 lg:pr-8">
          ...
          <div className="md:col-span-12 lg:col-span-4">
            ...
            <ul className="space-y-4 mb-8">
              <li>
                <a href="https://maps.google.com/?q=Kathmandu" target="_blank" rel="noopener noreferrer" className="flex gap-3 items-start text-slate-500 text-sm hover:text-brand transition-colors">
                  <FiMapPin className="mt-0.5 shrink-0 text-brand" size={16} />
                  <span>Creative Hub, Tech District<br />Kathmandu, Nepal</span>
                </a>
              </li>
              <li>
                <a href="tel:+97712345678" className="flex gap-3 items-center text-slate-500 text-sm hover:text-brand transition-colors">
                  <FiPhone className="shrink-0 text-brand" size={16} />
                  <span>+977 1 234 56789</span>
                </a>
              </li>
              <li>
                <a href="mailto:hello@koonji.com" className="flex gap-3 items-center text-slate-500 text-sm hover:text-brand transition-colors">
            ...
            <form className="flex gap-2" onSubmit={(e) => e.preventDefault()}>
              <input
                ...
                className="w-full bg-slate-50 border border-gray-200 text-sm rounded-xl px-4 py-3 outline-none focus:border-brand focus:ring-1 focus:ring-brand transition-all"
                required
              />
              <button
                type="submit"
